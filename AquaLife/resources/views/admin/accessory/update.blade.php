...
@section('breadcrumbs')
    {{ Breadcrumbs::render('admin.accessory.update', $data["accessory"]) }}
@endsection
                ...
                <form method="POST" action="{{ route('admin.accessory.update_save') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="number" class="form-control" name="price" value="{{ $data['accessory']->getPrice() }}" min="0.0001" step="0.0001" aria-describedby="priceHelpBlock" required/>
